    ...
    return (
      <View key={item.id} style={styles.listComment}>
        <Image
          ...
          source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxeVKKhcw5BVb33-sIFbVwBxpGvFjAORNkHA&usqp=CAU' }}
        />
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{
        ...
        />
        <Text style={styles.postComments} onPress={() => { postComments() }}>Send</Text>
      </View>
    </View>
  )
}
